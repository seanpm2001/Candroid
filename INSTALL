---
Installing this SNU IDE project by @seanpm2001
---

This project currently doesn't have to be installed to be viewed, and currently doesn't require installation, it is a basic website project that is compliant with web standards, so it should work in any web browser that respects WHATWG. It has a built-in IDE (integrated development environment, a place for writing computer programs/software)
...
---
Install instructions file version: 1 (Monday, August 23rd 2021 at 4:47 pm)
---
