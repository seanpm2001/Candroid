...
**Catalog version:** `17 (2023, Friday, January 20th at 6:15 pm PST)`
...
**File version:** `17 (2023, Friday, January 20th at 6:15 pm PST)`
...
<details><summary><p lang="en"><b>Version 8 (2022, Wednesday, November 30th at 8:15 pm PST)</b></p></summary>
...
- [x] Updated the main table
- - [x] Added an entry for Candroid Easter Egg and Candroid Market
- - [x] [INTERNAL] Added a source code comment regarding why it says 25 entries and not 26 (the `Coming soon` entry is counted)
- - [x] Updated the counter for how many items are on the catalog total
- - [x] Updated the counter for how many items are on the catalog total (excluding the Candroid Core)
- - [x] Updated the counter for how many items are on the catalog and have started development
- [x] Updated the `File info` section
...
<details><summary><p lang="en"><b>Version 11 (2022, Saturday, December 3rd at 6:03 pm PST)</b></p></summary>
...
- [x] Updated the main table
- - [x] Added an entry for Candroid Clock and Candroid Voicemail
- - [x] Added a counter for how many entries are on the catalog total (including the `Coming soon` entry)
- - [x] Updated the counter for how many items are on the catalog total
- - [x] Updated the counter for how many items are on the catalog total (excluding the Candroid Core)
- - [x] Updated the counter for how many items are on the catalog and have started development
- [x] Updated the `File info` section
...
</details> <!-- End of version 11 !-->

<details><summary><p lang="en"><b>Version 12 (2022, Sunday, December 4th at 8:57 pm PST)</b></p></summary>
...
- [x] Updated the main table
- - [x] Added an entry for Candroid Browser and Candroid Camera
- - [x] Updated athecounter for how many entries are on the catalog total (including the `Coming soon` entry)
- - [x] Updated the counter for how many items are on the catalog total
- - [x] Updated the counter for how many items are on the catalog total (excluding the Candroid Core)
- - [x] Updated the counter for how many items are on the catalog and have started development
- [x] Updated the `File info` section
...
</details> <!-- End of version 12 !-->

<details><summary><p lang="en"><b>Version 13 (2022, Monday, December 5th at 11:48 pm PST)</b></p></summary>
...
- [x] Updated the main table
- - [x] Added an entry for Candroid Calendar and Candroid Contacts
...
<details><summary><p lang="en"><b>Version 14 (2022, Wednesday, December 7th at 6:48 pm PST)</b></p></summary>

**This version was made by:** [`@seanpm2001`](https://github.com/seanpm2001/)

> **Note** _Coming back from a 1 day hiatus. Also, starting 2022, December 6th, my repository descriptions now start with an Emoji. This has not applied to older repositories from 2022, December 5th and below yet. It also doesn't apply to forks_
...
<details><summary><p lang="en"><b>Version 15 (2022, Thursday, December 8th at 3:50 pm PST)</b></p></summary>

**This version was made by:** [`@seanpm2001`](https://github.com/seanpm2001/)

> **Note** _Final update (for now) as I have no more entries to add_

> Changes:

- [x] Added a logo to the top of the file
- [x] Added a table for the logo, and the link to the separate repository
- [x] Updated the main table
- - [x] Added an entry for Candroid TV and Candroid Video
- - [x] Updated the counter for how many entries are on the catalog total (including the `Coming soon` entry)
- - [x] Updated the counter for how many items are on the catalog total
- - [x] Updated the counter for how many items are on the catalog total (excluding the Candroid Core)
- - [x] Updated the counter for how many items are on the catalog and have started development
...
</details> <!-- End of version 15 !-->

<details><summary><p lang="en"><b>Version 16 (2022, Wednesday, December 14th at 5:16 pm PST)</b></p></summary>

**This version was made by:** [`@seanpm2001`](https://github.com/seanpm2001/)

> **Note** _2 new entries added, but not yet under development._

> Changes:

- [x] Updated the main table
- - [x] Added a coming soon entry for Candroid Flashlight and Candroid Rotate
- - [x] Updated the counter for how many entries are on the catalog total (including the `Coming soon` entry)
- - [x] Updated the counter for how many items are on the catalog total
<!-- - - [x] Updated the counter for how many items are on the catalog total (excluding the Candroid Core) !-->
<!-- - - [x] Updated the counter for how many items are on the catalog and have started development !-->
...
</details> <!-- End of version 16 !-->


<details><summary><p lang="en"><b>Version 17 (2023, Friday, January 20th at 6:15 pm PST)</b></p></summary>

**This version was made by:** [`@seanpm2001`](https://github.com/seanpm2001/)

> **Note** _More entries coming soon, for now, everything is filled in_

> Changes:

- [x] Updated the main table
- - [x] Filled in entries for Candroid Flashlight and Candroid Rotate
- - [x] Some syntax improvements
- - [x] Updated the counter for how many entries are on the catalog total (including the `Coming soon` entry)
- - [x] Updated the counter for how many items are on the catalog total
- - [x] Updated the counter for how many items are on the catalog total (excluding the Candroid Core)
- - [x] Updated the counter for how many items are on the catalog and have started development
...
- - [x] Updated the line count
- [x] Updated the `File history` section
- - [x] Updated the entries for versions 14, 15, and 16
- - [x] Added an entry for version 17
- [ ] No other changes in version 17

</details> <!-- End of version 17 !-->
